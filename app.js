// elm-watch hot {"version":"1.1.1","targetName":"Template","webSocketPort":62861}
"use strict";
(() => {
...
var $author$project$Model$Inbox = function (folders) {
	return {folders: folders};
};
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			inbox: $author$project$Model$Inbox(_List_Nil),
			showInbox: false
		},
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Main$update = F2(
	function (message, model) {
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{showInbox: !model.showInbox}),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$Main$ClickedInbox = {$: 'ClickedInbox'};
...
var $author$project$Main$viewInbox = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text('Here is the inbox. It is a list of folders.'),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$ClickedInbox)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Avbryt')
					]))
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src('images/inbox.png'),
								$elm$html$Html$Events$onClick($author$project$Main$ClickedInbox)
							]),
						_List_Nil)
					])),
				model.showInbox ? $author$project$Main$viewInbox(model) : A2($elm$html$Html$div, _List_Nil, _List_Nil)
			]));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{init: $author$project$Main$init, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$update, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Message","aliases":{},"unions":{"Main.Message":{"args":[],"tags":{"ClickedInbox":[]}}}}})}});}(this));